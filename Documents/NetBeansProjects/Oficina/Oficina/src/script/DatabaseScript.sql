...
-- USE ESSE SCRIPT PARA CRIAR O BANCO DO ZERO. 
-- SEM PROCEDURES E NAO ALIMENTADO.
...
-------------------- ALTERACAO NO BANCO FEITO POSTERIOR A CRIACAO E QUE DEVE SER APLICADO JUNTAMENTE A CRIACAO-----------------------------------------------------
ALTER TABLE `oficina`.`ordem` 
DROP FOREIGN KEY `fk_ordem_cliente1`,
DROP FOREIGN KEY `fk_ordem_pagamento1`;
ALTER TABLE `oficina`.`ordem` 
CHANGE COLUMN `status_ordem` `status_ordem` TINYINT UNSIGNED NOT NULL DEFAULT 0 ,
CHANGE COLUMN `pagamento_idpagamento` `pagamento_idpagamento` INT(10) UNSIGNED NULL ,
CHANGE COLUMN `cliente_idcliente` `cliente_idcliente` INT(10) UNSIGNED NULL ;
ALTER TABLE `oficina`.`ordem` 
ADD CONSTRAINT `fk_ordem_cliente1`
  FOREIGN KEY (`cliente_idcliente`)
  REFERENCES `oficina`.`cliente` (`idcliente`)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_ordem_pagamento1`
  FOREIGN KEY (`pagamento_idpagamento`)
  REFERENCES `oficina`.`pagamento` (`idpagamento`)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION;
--------------------------------------------------------------------------------
ALTER TABLE `oficina`.`ordem` 
ADD COLUMN `placa_veiculo_ordem` VARCHAR(8) NULL AFTER `cliente_idcliente`;
--------------------------------------------------------------------------------
ALTER TABLE `oficina`.`ordem` 
DROP FOREIGN KEY `fk_ordem_cliente1`,
DROP FOREIGN KEY `fk_ordem_pagamento1`;
ALTER TABLE `oficina`.`ordem` 
CHANGE COLUMN `pagamento_idpagamento` `pagamento_idpagamento` INT(10) UNSIGNED NOT NULL DEFAULT 1 ,
CHANGE COLUMN `cliente_idcliente` `cliente_idcliente` INT(10) UNSIGNED NOT NULL DEFAULT 2 ;
ALTER TABLE `oficina`.`ordem` 
ADD CONSTRAINT `fk_ordem_cliente1`
  FOREIGN KEY (`cliente_idcliente`)
  REFERENCES `oficina`.`cliente` (`idcliente`)
